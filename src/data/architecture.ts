...
export const ARCHITECTURE_CATEGORIES: ConceptCategory[] = [
  {
    ...
    concepts: [
      { term: "Rate Limiting", definition: "Limit requests from clients", deepDiveId: "rate-limiting" },
      { term: "Caching", definition: "Store data for faster access", deepDiveId: "caching" },
      { term: "Load Balancing", definition: "Distribute traffic evenly", deepDiveId: "load-balancing" },
  ...
  },
  {
    ...
    concepts: [
      ...
      { term: "Sharding", definition: "Split data across DBs", deepDiveId: "sharding" },
      { term: "Partitioning", definition: "Divide large tables" },
      { term: "Replication", definition: "Keep data copies", deepDiveId: "replication" },
      { term: "Leader Election", definition: "Choose leader node" },
      { term: "CAP Theorem", definition: "Consistency trade-offs", deepDiveId: "consistency-models" },
      { term: "Eventual Consistency", definition: "Data syncs over time", deepDiveId: "consistency-models" },
    ],
  },
  {
